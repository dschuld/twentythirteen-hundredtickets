...
function _stripDomainFromLink(link) {	
	var targetHref = link.href.replace('https://localhost/wordpress', '');
	targetHref = targetHref.replace('http://localhost/wordpress', '');
	
	return targetHref.replace('localhost/wordpress', '');
