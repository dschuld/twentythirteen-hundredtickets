...
function enqueue_scripts() {
    ...
    wp_enqueue_script('s11script', get_stylesheet_directory_uri() . '/js/all.js', array('jquery', 'googlemapsapi', 'aws-sdk-js'), 1.0, true);
    ...
    wp_localize_script('s11script', 'wpdata', array(
        ...
        'mapStyleUrl' => get_stylesheet_directory_uri() . '/js/mapStyle.json'
    ));
...
function init_deps() {
    ...
    wp_register_script('aws-sdk-js', 'https://sdk.amazonaws.com/js/aws-sdk-2.7.20.min.js');
}
...
function demo_exclude_category($wp_query) {
    ...
    $category = get_cat_ID(get_query_var('category_name'));
